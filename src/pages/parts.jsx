...
import ItemCanvas7 from "../components/ItemCanvas/ItemCanvas7";
...
const Parts = () => {
  ...
  useEffect(() => {
    const onClickMintPartNft = async () => {
      ...
      try {
        console.log(metadataURI, ItemIndex, selectedTokenId);
  ...
  return (
    <motion.div
      className="flex justify-between min-h-screen bg-slate-500 pb-44"
      initial={{ opacity: 0.2 }}
      animate={{ opacity: 1 }}
      exit={{ opacity: 0 }}
